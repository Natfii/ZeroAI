 ...
 *
 * Because the native EventSource API does not support all auth/session controls we
 * need, this client uses fetch plus a ReadableStream and relies on the same-origin
