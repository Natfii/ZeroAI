...
import { isPageEnabled } from './platform.config';
    ...
    <LocaleContext.Provider value={{ locale, setAppLocale }}>
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route path="/integrations" element={isPageEnabled('integrations') ? <Integrations /> : <Navigate to="/" replace />} />
          <Route path="/memory" element={<Memory />} />
          <Route path="/config" element={isPageEnabled('config') ? <Config /> : <Navigate to="/" replace />} />
          <Route path="/cost" element={<Cost />} />
          <Route path="/logs" element={isPageEnabled('logs') ? <Logs /> : <Navigate to="/" replace />} />
