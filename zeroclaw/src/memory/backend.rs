...
const SELECTABLE_MEMORY_BACKENDS: [MemoryBackendProfile; 2] = [
    SQLITE_PROFILE,
    NONE_PROFILE,
];
...
mod tests {
    ...
    #[test]
    fn removed_backends_classify_as_unknown() {
        assert_eq!(classify_memory_backend("lucid"), MemoryBackendKind::Unknown);
        assert_eq!(
        ...
        assert_eq!(classify_memory_backend("qdrant"), MemoryBackendKind::Unknown);
    }
