...
impl Provider for AnthropicProvider {
    async fn chat_with_system(
        ...
        request = super::apply_custom_headers(request, &self.custom_headers);
    ...
    async fn chat(
        ...
        let req = self.apply_auth(req, credential);
