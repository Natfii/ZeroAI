...
impl Tool for CronAddTool {
    ...
    fn description(&self) -> &str {
        "Create a scheduled cron job (shell or agent) with cron/at/every schedules. \
         ...
         To deliver output to a channel (Discord, Telegram), set \
            ...
            "properties": {
                ...
                "delivery": {
                    ...
                    "properties": {
                        ...
                        "channel": { "type": "string", "enum": ["telegram", "discord"], "description": "Channel type to deliver to" },
                        "to": { "type": "string", "description": "Target: Discord channel ID or Telegram chat ID" },
