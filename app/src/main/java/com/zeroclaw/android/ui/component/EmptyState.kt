 ...
 * expected.
 *
 * @param icon Decorative icon displayed above the message when [headerContent] is `null`.
 ...
 * @param headerContent Optional decorative content shown above the message. When provided, it
 *   replaces [icon] and can be used for richer visuals such as the mini Zero mascot.
 */
@Composable
fun EmptyState(
