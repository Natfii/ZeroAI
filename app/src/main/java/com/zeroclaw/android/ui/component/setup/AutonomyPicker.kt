...
private val AUTONOMY_OPTIONS =
    listOf(
        AutonomyOption(
            id = "readonly",
            title = "Read-only",
            description = "Agent can only read files and answer questions.",
            icon = Icons.Filled.MenuBook,
        ),
        AutonomyOption(
            id = "supervised",
            title = "Supervised",
            description = "Agent asks before taking risky actions. Recommended for most users.",
            icon = Icons.Filled.Shield,
        ),
        AutonomyOption(
            id = "full",
            title = "Full",
            description = "Agent has unrestricted access to tools and commands.",
 ...
 * icon, title, and description. The "Full" option uses warning styling
