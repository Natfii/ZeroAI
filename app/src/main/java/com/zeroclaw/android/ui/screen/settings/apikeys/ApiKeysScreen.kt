 ...
 * @param onRequestSecureReveal Callback to request device-credential or PIN
 *   authentication for revealing a key.
...
fun ApiKeysScreen(
    ...
    onRequestSecureReveal: (keyId: String) -> Unit,
    ...
    val anthropicSheetVisible by apiKeysViewModel.anthropicSheetVisible.collectAsStateWithLifecycle()
    val anthropicSheetLoading by apiKeysViewModel.anthropicSheetLoading.collectAsStateWithLifecycle()
    val anthropicSheetError by apiKeysViewModel.anthropicSheetError.collectAsStateWithLifecycle()

    AnthropicCodeSheet(
        visible = anthropicSheetVisible,
        onSubmit = apiKeysViewModel::submitAnthropicCode,
        onDismiss = apiKeysViewModel::dismissAnthropicSheet,
    ...
    ApiKeysContent(
        ...
        onRequestSecureReveal = onRequestSecureReveal,
 ...
 * @param onRequestSecureReveal Request secure auth for a key reveal.
                        ...
                        ApiKeyItem(
                            ...
                            onRevealToggle = {
                                if (state.revealedKeyId == apiKey.id) {
                                    ...
                                    onRequestSecureReveal(apiKey.id)
                                }
                            },
