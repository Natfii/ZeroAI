...
/**
 * Onboarding step for optional chat-app configuration.
 *
 * Shows a selectable list of chat app types. When a type is selected,
 * displays the required fields only. Users can skip this step since chat apps
...
fun ChannelSetupStep(
    ...
    Column(modifier = Modifier.imePadding().verticalScroll(rememberScrollState())) {
        ...
        Text(
            text =
                "Connect a chat platform so your agent can send and receive messages. " +
                    "You can skip this and add chat apps later in Settings.",
        ...
        Text(
            text = "You can skip this step and add chat apps later.",
