...
sealed interface TerminalBlock {
     ...
     * @property providerId Provider identifier for icon attribution (e.g. "nano",
     *   "anthropic"). Null for responses where the provider is unknown or for
     *   entries restored from persistence without provider metadata.
     */
    data class Response(
        override val id: Long,
        override val timestamp: Long,
