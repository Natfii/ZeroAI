...
private class TestSettingsRepository : SettingsRepository {
    ...
    override suspend fun setTwitterBrowseEnabled(enabled: Boolean) { /* no-op */ }

    override suspend fun setTwitterBrowseCookieString(cookieString: String) { /* no-op */ }

    override suspend fun setTwitterBrowseMaxItems(max: Long) { /* no-op */ }

    override suspend fun setTwitterBrowseTimeoutSecs(secs: Long) { /* no-op */ }
